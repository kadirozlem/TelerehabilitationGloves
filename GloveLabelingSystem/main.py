...
class TestScreen:
    ...
    def __init__(self):
        ...
        self.window.title("GloveLabellingSystem")
    ...
    def InitInformationBoxes(self):
        ...
        self.InfoBox_Gyro_X = InformationBox(self.window, 5, "Gyro X", "0.1215", None)
    ...
    def InitButtons(self):
        ...
        self.Test_Option.config(height=Configuration.Window.button_height,width=Configuration.Window.button_width-1)
